            ...
            <div className="  border-gray-200 ">
              <div className="bg-white h-16 justify-between items-center mx-auto px-4 flex">
                ...
                <div className="lg:block mr-auto ml-40 hidden relative max-w-xs">
                  ...
                  <button class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Clock in</button>
                </div>
                <div className="md:space-x-6 justify-end items-center ml-auto flex space-x-3">
                  ...
                  <div className="justify-center items-center flex relative">
                    ...
                    <p className="font-semibold text-sm">SAIL INNOVATION</p>
                  </div>
                </div>
              </div>
            </div>
