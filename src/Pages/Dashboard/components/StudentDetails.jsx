  ...
  const StudentDetails = () => {
    return (
      ...
      <button class="bg-transparent border border-gray-500 rounded-md py-1 px-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700 ml-96">This year</button>
      <button class="bg-transparent border border-gray-500 rounded-md py-1 px-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">download info</button>
      </h1>
        </div>
      <div>
        <h1 className="text-3xl font-bold text-gray-800 mb-4">Thickbaby Africa</h1>
      </div>
