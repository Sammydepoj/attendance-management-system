// importing the icons from react icon
    ...
    <div className="grid grid-cols-[15rem_1fr]">
      ...
      <div>
        <div className="flex justify-between p-4">
          <div className="">
            <p className=" text-black-600 font-bold">Hi Admin</p>
        ...
        <div className="border">
          ...
          <div>
            <div className="flex gap-0">
              <div className="bg-white shadow rounded-lg  h-[27rem] w-[60%] m-16 ml-8 mr-16">
                <h1 className="font-bold text-[--green] mt-5 ml-5 text-black text-2xl">
                  Attendance Based On Courses
                </h1>
                <div className="flex">
                  <div>
                    <p className="font-bold text-black flex items-center gap-2 mt-5 ml-5">
                      <FaVideoSlash className="text-2xl text-[--gold]" /> Tech
                      Talent
                    </p>
              ...
              <div className="bg-white shadow rounded-lg  h-[27rem] w-[60%] m-16">
